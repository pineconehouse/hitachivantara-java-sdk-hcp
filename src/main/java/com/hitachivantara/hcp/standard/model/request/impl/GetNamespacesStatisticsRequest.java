...
public class GetNamespacesStatisticsRequest extends NamespaceInfoRequest<GetNamespacesStatisticsRequest> {

	public GetNamespacesStatisticsRequest(String namespace) {
