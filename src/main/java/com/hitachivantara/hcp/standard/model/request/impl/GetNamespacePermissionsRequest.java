...
public class GetNamespacePermissionsRequest extends NamespaceInfoRequest<GetNamespacePermissionsRequest> {

	public GetNamespacePermissionsRequest(String namespace) {
