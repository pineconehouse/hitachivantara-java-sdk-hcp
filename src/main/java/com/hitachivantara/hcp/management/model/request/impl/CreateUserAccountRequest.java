...
public class CreateUserAccountRequest extends TenantUserAccountResourceRequest<CreateUserAccountRequest> {
	...
	public CreateUserAccountRequest(String tenant) {
		super(Method.PUT, tenant, "-");
	}

	@Override
	public String getResourceIdentifier() {
		return URLUtils.simpleCatPaths(KEY_TENANTS, this.getTenant(), KEY_USER_ACCOUNTS);
	}

	public CreateUserAccountRequest withUserAccount(UserAccount userAccount) {
