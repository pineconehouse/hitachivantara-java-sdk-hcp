...
public class DeleteUserAccountRequest extends TenantUserAccountResourceRequest<DeleteUserAccountRequest> {

	public DeleteUserAccountRequest() {
		super(Method.DELETE);
	}

	public DeleteUserAccountRequest(String tenant, String userName) {
		super(Method.DELETE, tenant, userName);
	}
