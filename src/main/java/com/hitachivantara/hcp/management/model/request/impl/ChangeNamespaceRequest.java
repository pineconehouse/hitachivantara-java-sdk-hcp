...
public class ChangeNamespaceRequest extends NamespaceResourceRequest<ChangeNamespaceRequest> {

	private NamespaceSettings namespaceSettings;

	public ChangeNamespaceRequest() {
		super(Method.POST);
	}

	public ChangeNamespaceRequest(String tenant) {
		super(Method.POST, tenant, "");
	}

	public ChangeNamespaceRequest withSettings(NamespaceSettings ns) {
	...
	public String getResourceIdentifier() {
		return URLUtils.simpleCatPaths(KEY_TENANTS, this.getTenant(), KEY_NAMESPACES, this.getNamespace());
	}
