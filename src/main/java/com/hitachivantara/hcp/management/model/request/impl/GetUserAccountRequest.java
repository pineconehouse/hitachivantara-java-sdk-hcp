...
public class GetUserAccountRequest extends TenantUserAccountResourceRequest<GetUserAccountRequest> {

	public GetUserAccountRequest() {
		super(Method.GET);
	}

	public GetUserAccountRequest(String tenant, String userName) {
